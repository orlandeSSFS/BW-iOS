...
print (even % 2)
print (odd % 2)
print ("You can determine if an integer is even or odd by looking at the remainder of dividing the integer by 2. If the result is 0, the integer is even. If the result is 1, the integer is odd.")
/*:
