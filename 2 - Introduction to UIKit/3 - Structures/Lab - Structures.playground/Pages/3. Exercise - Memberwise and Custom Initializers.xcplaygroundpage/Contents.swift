...
var favoriteBook = Book(title: "The Greatest Book in the World", author: "The Greatest Author in the World", pages: 9002, price: 0.01)
print("My favorite book is \"\(favoriteBook.title)\", written by \(favoriteBook.author). It is \(favoriteBook.pages) pages long and sells for $\(favoriteBook.price).")
/*:
...
var laptop1 = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 1999)
var laptop2 = Laptop(yearPurchased: 2000)
/*:
